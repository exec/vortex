...
impl NetworkManager {
    pub async fn new() -> Result<Self> {
        ...
        networks.insert("default".to_string(), NetworkConfig {
    ...
    pub async fn assign_vm_to_network(&mut self, vm_id: &str, network_name: &str) -> Result<VmNetwork> {
        ...
        self.vm_networks.insert(vm_id.to_string(), vm_network.clone());
